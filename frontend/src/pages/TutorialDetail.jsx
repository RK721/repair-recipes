    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Tutorial Not Found</h2>
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
              ...
              <Link to="/search" className="hover:text-blue-600 transition-colors duration-200">Tutorials</Link>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                {tutorial.estimated_time && (
                  <div className="flex items-center text-gray-600">
                    ...
                    <span className="ml-1">{formatDuration(tutorial.estimated_time)}</span>
                  </div>
                )}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
              ...
              {tutorial.steps && tutorial.steps.length > 0 && (
                <div className="card p-8 animate-fade-in">
                  <div className="flex items-center mb-8">
                    ...
                    <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">Step-by-Step Instructions</h2>
                  </div>
                      ...
                      <div key={step.id || idx} className="flex">
                        ...
                        <div className="flex-shrink-0 mr-6">
                          <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center">
                            <span className="text-white font-bold text-lg">{step.step_number || idx + 1}</span>
                          </div>
                            ...
                            {step.image && (
                              <div className="mt-4">
                                <img
                                  ...
                                  alt={`Step ${step.step_number || idx + 1} illustration`}
              ...
              {tutorial.tools && tutorial.tools.length > 0 && (
                <div className="card p-6 animate-fade-in">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Required Tools</h3>
                  </div>
                    ...
                    {tutorial.tools.map((tool) => (
                      <li key={tool.id} className="flex items-start">
                        ...
                        <div className="flex-1">
                          <span className="text-gray-800 text-sm">{tool.name}</span>
                          {tool.affiliate_link && (
                            <a
              ...
              {tutorial.parts && tutorial.parts.length > 0 && (
                <div className="card p-6 animate-fade-in">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Required Parts</h3>
                  </div>
                  
                  <ul className="space-y-3">
                    {tutorial.parts.map((part) => (
                      <li key={part.id} className="border-b border-gray-100 pb-3 last:border-b-0 last:pb-0">
                        <div className="flex items-start">
                          <svg className="w-4 h-4 text-yellow-500 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <div className="flex-1">
                            <div className="text-gray-800 text-sm font-medium">{part.name}</div>
                            <div className="text-gray-500 text-xs mt-1">Part #: {part.part_number}</div>
                            {part.affiliate_link && (
                              <a
                  ...
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center mr-3">
                      <span className="text-white font-semibold text-sm">
                        {tutorial.author.username ? tutorial.author.username.charAt(0).toUpperCase() : 'A'}
                      </span>
                    </div>
                    <div>
          ...
          <div className="mt-16">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Find More Tutorials</h3>
              <p className="text-gray-600 mb-8">
                Looking for more repair guides? Browse our collection of tutorials.
              </p>
              <Link
                to="/search"
