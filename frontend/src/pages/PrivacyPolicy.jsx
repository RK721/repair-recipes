        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card p-8 mb-8 animate-fade-in">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">Our Commitment to Privacy</h2>
            </div>
            
            <p className="text-gray-700 text-lg leading-relaxed">
              <strong>Write2Repair</strong> respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Create and maintain your user account</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Content Delivery</h3>
                    <p className="text-sm text-gray-600">Provide and improve our tutorial services</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Understand usage patterns and improve our platform</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Meet legal obligations and enforce our terms</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card p-8 mb-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                <h3 className="font-semibold text-gray-900 mb-3">Cookie Management</h3>
                <ul className="space-y-2 text-gray-700 text-sm">
