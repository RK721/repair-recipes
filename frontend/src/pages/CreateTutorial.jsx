  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/tutorials/create/",
        formData,
        {
          headers: {
      ...
      setSuccess(
        "Tutorial submitted successfully! Thank you for contributing to the community."
      );
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 animate-slide-up">
              Share your automotive knowledge and help others fix their vehicles
              with confidence.
            </p>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(e, ["vehicle", null, "engine"])
                    }
                  ...
                  >
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(e, ["parts", i, "part_number"])
                        }
                        className="input w-full"
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            handleChange(e, ["steps", i, "instruction"])
                          }
                          className="textarea w-full"
                          placeholder={`Describe what to do in step ${
                            i + 1
                          }...`}
                          rows={4}
                          required
