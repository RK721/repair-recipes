                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Visit our Submit Tutorial page and follow the
                        step-by-step guide.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">
                        Can I edit my submitted tutorials?
                      </h4>
                      <p className="text-sm text-gray-600">
                        Yes, you can manage your tutorials from your profile
                        page.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">
                        Is Write2Repair free to use?
                      </h4>
                      <p className="text-sm text-gray-600">
                        Yes, our platform is completely free for both viewing
                        and submitting tutorials.
                      </p>
                    </div>
                  </div>
                </div>
