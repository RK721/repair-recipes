        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 animate-slide-up">
              Manage and view all the repair tutorials you've shared with the
              community
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="card p-6 text-center animate-fade-in">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {tutorials.reduce(
                  (sum, tutorial) => sum + (tutorial.views || 0),
                  0
                )}
              </div>
            ...
            <div className="card p-6 text-center animate-fade-in">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {tutorials.reduce(
                  (sum, tutorial) => sum + (tutorial.likes || 0),
                  0
                )}
              </div>
          ...
          {tutorials.length === 0 ? (
            <div className="card p-12 text-center animate-fade-in">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                You haven't submitted any tutorials yet. Share your automotive
                knowledge and help others fix their vehicles!
              </p>
              <Link to="/submit" className="btn btn-primary btn-lg group">
                <svg
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Link to="/submit" className="btn btn-primary btn-sm group">
                  <svg
              ...
              <div className="grid gap-6">
                {tutorials.map((tutorial) => (
                  <div
                    key={tutorial.id}
                    className="card p-6 hover:shadow-medium transition-all duration-300 group animate-fade-in"
                  >
